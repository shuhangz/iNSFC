...
%行距正常情况下是由文档的设置来设定的，比如\linespread,\baselinestretch,\fontsize等命令，以及zhlineskip宏包等。比如：
\linespread{1.3}
...
\begin{figure*}[htb!]
	\centering  
	\subfloat[涅尓瓦]{\includegraphics[width=0.17\textwidth]{./Nerva}\label{subfig:Nerva}
	}  
